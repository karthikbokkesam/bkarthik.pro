---
title: bkarthik.pro
description: I guess it's never too late to start
...
- Adding MX and A records to AWS route 53 to add support for email and prove ownership of domain via DNS
